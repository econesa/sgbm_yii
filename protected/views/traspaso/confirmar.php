...
<div class="header2">
	Verifique si la información mostrada es correcta. En caso positivo, presione <i>Guardar</i>.
</div>
<br/>
<fieldset>
<?php	
...
<div class="operaciones">
	<div class="left">
		...
		echo CHtml::link($imghtml, array('index')).'&nbsp;&nbsp;&nbsp;';
	...
	<?php 
		...
		$imghtml2=CHtml::image('images/no_mini.png','Rechazar', array('title'=>'Rechazar'));
		echo CHtml::link($imghtml2, array('rechazar', 'id'=>$model->id)).'&nbsp;&nbsp;&nbsp;';
		...
		echo CHtml::imageButton('images/Apply.png', array('title'=>'Aceptar'), array('confirm'=>'¿Está seguro que desea crear y enviar el acta?' )); 
		$this->endWidget();
	?>
	</div>
</div>
